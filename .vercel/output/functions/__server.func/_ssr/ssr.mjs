...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-CUYAQBFn.mjs");
...
var manifest = {
	"144ddc71608f67875a9b2dd84e38eed39524ac58c5e637c48b2867af37b28fbf": {
		functionName: "getMacro_createServerFn_handler",
		importer: () => import("./api-fYIazK-i.mjs")
	},
	"66087b44c4898dd8924b2412aa4b0d04680fda881918579ff268fb46521d61f8": {
		functionName: "getUniverse_createServerFn_handler",
		importer: () => import("./api-fYIazK-i.mjs")
	},
	"f252ece4e77eced02d9e12efeb563da73c54fb1875c0f358ade133f88f2004ea": {
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-IT0V90TG.mjs").then((n) => n.t),
