...
//#region node_modules/.nitro/vite/services/ssr/assets/router-IT0V90TG.js
...
function Tip({ label, children, className }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Root3, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Trigger, {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
			type: "button",
			className: cn("inline-flex items-center gap-1 text-left text-faint hover:text-muted", className),
			children
		})
...
var styles_default = "/assets/styles-DhnpYMGF.css";
var APP_NAME = "ATLAS";
var Route$1 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "Universe-first crypto desk — radar, alpha, harvest."
			},
			{
				name: "theme-color",
				content: "#08090c"
...
var $$splitComponentImporter = () => import("./routes-CLCN15LG.mjs");
...
//#endregion
export { Tip as n, cn as r, router_exports as t };
